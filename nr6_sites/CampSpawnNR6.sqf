...
_climate = (_logic getVariable "_climate");
_Campsize = (_logic getVariable "_Campsize");
_militarytype = (_logic getVariable "_militarytype");
_usecup = (_logic getVariable "_usecup");
